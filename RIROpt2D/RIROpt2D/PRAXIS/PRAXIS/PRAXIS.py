...
#
  scbd = 1.0
  illc = False
  ktm = 0 #AHMED EDIT, -1 IS LOWEST VALUE POSSIBLE (INSTANTLY ENDS WHEN IT THINKS IT HAS OPTIMA)
...
#
    for k in range ( 2, n + 1 ): #AHMED EDIT HERE (2 -> 1) - THIS KILLS >1 VAR FCT OPTIMISATION
...
#
        if ( illc ):
          ...
          fx = f ( x, n )
          nf = nf + 1
          print('randomstep applied') #AHMED EDIT
#
...
#
      for k2 in range ( 1, k ): #AHMED EDIT HERE (K -> K+1) to make it work for 1 var
