...
public class automation_macro extends StarMacro {
  ...
  private void execute0() {
    ...
    expressionReport_ventx1.setDefinition("-0.006900000000000001");

    ExpressionReport expressionReport_venty1 = 
      ((ExpressionReport) simulation_0.getReportManager().getReport("Vent Location Y1"));

    expressionReport_venty1.setDefinition("-0.0072");

    ExpressionReport expressionReport_ventx2 = 
      ((ExpressionReport) simulation_0.getReportManager().getReport("Vent Location X2"));

    expressionReport_ventx2.setDefinition("-0.0013");

    ExpressionReport expressionReport_venty2 = 
      ((ExpressionReport) simulation_0.getReportManager().getReport("Vent Location Y2"));

    expressionReport_venty2.setDefinition("0.013");

    ExpressionReport expressionReport_ventx3 = 
      ((ExpressionReport) simulation_0.getReportManager().getReport("Vent Location X3"));

    expressionReport_ventx3.setDefinition("0.026199999999999998");

    ExpressionReport expressionReport_venty3 = 
      ((ExpressionReport) simulation_0.getReportManager().getReport("Vent Location Y3"));

    expressionReport_venty3.setDefinition("-0.0216");

    ExpressionReport expressionReport_injectionx1 = 
      ((ExpressionReport) simulation_0.getReportManager().getReport("Injection Location X1"));

    expressionReport_injectionx1.setDefinition("1");

    ExpressionReport expressionReport_injectiony1 = 
      ((ExpressionReport) simulation_0.getReportManager().getReport("Injection Location Y1"));

    expressionReport_injectiony1.setDefinition("1");

    ExpressionReport expressionReport_injectionx2 = 
      ((ExpressionReport) simulation_0.getReportManager().getReport("Injection Location X2"));

    expressionReport_injectionx2.setDefinition("1");

    ExpressionReport expressionReport_injectiony2 = 
      ((ExpressionReport) simulation_0.getReportManager().getReport("Injection Location Y2"));

    expressionReport_injectiony2.setDefinition("1");

    ExpressionReport expressionReport_injectionx3 = 
      ((ExpressionReport) simulation_0.getReportManager().getReport("Injection Location X3"));

    expressionReport_injectionx3.setDefinition("1");

    ExpressionReport expressionReport_injectiony3 = 
      ((ExpressionReport) simulation_0.getReportManager().getReport("Injection Location Y3"));

    expressionReport_injectiony3.setDefinition("1");

    ExpressionReport expressionReport_injectionx4 = 
      ((ExpressionReport) simulation_0.getReportManager().getReport("Injection Location X4"));

    expressionReport_injectionx4.setDefinition("1");

    ExpressionReport expressionReport_injectiony4 = 
      ((ExpressionReport) simulation_0.getReportManager().getReport("Injection Location Y4"));

    expressionReport_injectiony4.setDefinition("1");

    ExpressionReport expressionReport_injectionx5 = 
      ((ExpressionReport) simulation_0.getReportManager().getReport("Injection Location X5"));

    expressionReport_injectionx5.setDefinition("1");

    ExpressionReport expressionReport_injectiony5 = 
      ((ExpressionReport) simulation_0.getReportManager().getReport("Injection Location Y5"));

    expressionReport_injectiony5.setDefinition("1");

    ExpressionReport expressionReport_injectionx6 = 
      ((ExpressionReport) simulation_0.getReportManager().getReport("Injection Location X6"));

    expressionReport_injectionx6.setDefinition("0");

    ExpressionReport expressionReport_injectiony6 = 
      ((ExpressionReport) simulation_0.getReportManager().getReport("Injection Location Y6"));

    expressionReport_injectiony6.setDefinition("0");
    ...
    meshManager_0.removeInvalidCells(userFieldFunction_0, new NeoObjectVector(new Object[] {region_0}), NeoProperty.fromString("{\'minimumContiguousFaceArea\': 0.0, \'minimumCellVolumeEnabled\': false, \'minimumVolumeChangeEnabled\': false, \'functionOperator\': 0, \'minimumContiguousFaceAreaEnabled\': false, \'minimumFaceValidityEnabled\': false, \'functionValue\': 0.012, \'functionEnabled\': true, \'function\': \'Porosity\', \'minimumVolumeChange\': 0.5, \'minimumCellVolume\': 0.0, \'minimumCellQualityEnabled\': false, \'minimumCellQuality\': 1.0E-8, \'minimumDiscontiguousCells\': 100, \'minimumDiscontiguousCellsEnabled\': true, \'minimumFaceValidity\': 0.51}"));
    //^ MAKE SURE THIS POROSITY VALUE HERE IS CORRECT (MANUALLY)
    ...
    ////////// RE-ADJUSTING SCENE 1 (FULL-VIEW) //////////
    Scene scene_0 = 
    ...
    ////////// RE-ADJUSTING SCENE 2 (CLOSEUP) //////////
    Scene scene_1 = 
      simulation_0.getSceneManager().getScene("Ports and Flow Closeup");

    // Flow displayer
    ScalarDisplayer scalarDisplayer_6 = 
      ((ScalarDisplayer) scene_1.getDisplayerManager().getDisplayer("Flow"));
    
    scalarDisplayer_6.getInputParts().setQuery(null); // Clear all inputs
    
    scalarDisplayer_6.getInputParts().setObjects(region_0, boundary_mainregion0, boundary_mainregion1, boundary_mainregion2);

    // Injection displayer
    ScalarDisplayer scalarDisplayer_7 = 
      ((ScalarDisplayer) scene_1.getDisplayerManager().getDisplayer("Injection"));

    scalarDisplayer_7.getInputParts().setQuery(null);
    scalarDisplayer_7.getInputParts().setObjects(region_new_port_0);
    
    // Vent displayer
    ScalarDisplayer scalarDisplayer_8 = 
      ((ScalarDisplayer) scene_1.getDisplayerManager().getDisplayer("Venting"));

    scalarDisplayer_8.getInputParts().setQuery(null);
    scalarDisplayer_8.getInputParts().setObjects(region_new_vent_0);
    ...
    scene_0.printAndWait(resolvePath("D:/Ahmeds_Files/PhD/Simulations/Optimisation/Codes/OptimisationFiles/Images/1_Validation_Opt_Flow_C3_96.png"), 1, 1200, 800, true, true);
    scene_0.printAndWait(resolvePath("D:/Ahmeds_Files/PhD/Simulations/Optimisation/Codes/OptimisationFiles/Images2/1_Validation_Opt_Flow_Closeup_C3_96.png"), 1, 1200, 800, true, true);
    ...
    monitorPlot_0.getDataSetManager().writeCSVDataSet(monitorDataSet_0, resolvePath("D:/Ahmeds_Files/PhD/Simulations/Optimisation/Codes/OptimisationFiles/Data/1_Validation_C3_Fill_eff_dataset_96.csv"), ",");
    

    ////////// SAVING FILE //////////
    simulation_0.saveState("D:/Ahmeds_Files/PhD/Simulations/Optimisation/Codes/OptimisationFiles/SaveFiles/1_Validation_Opt_C3_auto_96.sim");
